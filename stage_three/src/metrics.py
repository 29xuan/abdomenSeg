...
if __name__ == '__main__':
    ...
    ground_truth_folder = '/Volumes/Xuan_ExFAT/open_project/FLARE/Tuning/labels'
    predicted_folder = '/Volumes/Xuan_ExFAT/open_project/FLARE/Tuning/pseudo'

    # Process the folders and compute metrics
    avg_metrics = process_folder(ground_truth_folder, predicted_folder)
