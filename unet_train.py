...
def run_finetuning(args, model, train_loader, val_loader, optimizer, loss_function, dice_metric, post_label, post_pred, output_path, device, num_epochs=50, eval_interval=5):
    best_dice = 0.0
    train_loss_values = []
    val_dice_values = []
...
if __name__ == "__main__":
    ...
    if args.flag == 'label':
        train_loader = get_roi_data_loader(labeled_roi_image_data_dir, labeled_roi_label_data_dir, train_labeled_transforms, batch_size=2)
    elif args.flag == 'aug':
        train_loader = get_roi_data_loader(labeled_roi_aug_image_data_dir, labeled_roi_label_data_dir, train_labeled_transforms, batch_size=2)
    elif args.flag == 'pseudo50':
        train_loader = get_mixed_roi_data_loader(labeled_roi_image_data_dir, labeled_roi_label_data_dir, \
                                                 pseudo_roi_image_data_dir, pseudo_roi_label_data_dir, 50, \
                                                    train_labeled_transforms, batch_size=2)
    elif args.flag == 'pseudo25':
        train_loader = get_mixed_roi_data_loader(labeled_roi_image_data_dir, labeled_roi_label_data_dir, \
                                                 pseudo_roi_image_data_dir, pseudo_roi_label_data_dir, 25, \
                                                    train_labeled_transforms, batch_size=2)
    elif args.flag == 'pseudo100':
        train_loader = get_mixed_roi_data_loader(labeled_roi_image_data_dir, labeled_roi_label_data_dir, \
                                                 pseudo_roi_image_data_dir, pseudo_roi_label_data_dir, 100, \
                                                    train_labeled_transforms, batch_size=2)
    ...
    # Run Fine-Tuning
    run_finetuning(args, model, train_loader, val_loader, optimizer, loss_function, dice_metric, post_label, post_pred, output_path, device, num_epochs=1000, eval_interval=3)
